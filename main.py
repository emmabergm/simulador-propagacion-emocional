...
from src.Menus import menu_grupos
...
if os.path.exists(archivo_grupos):
    ...
    df_grupos = pd.DataFrame(columns=["nombre", "situacion", "situacion_2"])
    

nombre_grupo = input("Ingrese el nombre de su grupo: ")

tipo_situacion, tipo_situacion_2 = menu_grupos(df_grupos, nombre_grupo)

if tipo_situacion is not None:
    print("Ese grupo ya esta registrado")
    menu_principal = "si"
